...
export const leaveBalanceService = {
  ...
  async getMyBalances(year?: number): Promise<Array<LeaveBalanceResponse>> {
    return apiClient.get<Array<LeaveBalanceResponse>>('/leave/balances/me', {
      year,
    })
  },
  ...
  async getEmployeeBalances(
    employeeId: string,
    year?: number,
  ): Promise<Array<LeaveBalanceResponse>> {
    return apiClient.get<Array<LeaveBalanceResponse>>(
...
export const leaveRequestService = {
  ...
  async getMyRequests(
    status?: LeaveStatus,
    year?: number,
  ): Promise<Array<LeaveRequestResponse>> {
    return apiClient.get<Array<LeaveRequestResponse>>('/leave/requests/me', {
      status,
      year,
    })
  },
