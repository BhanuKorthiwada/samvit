...
function AttendancePage() {
  ...
  const totalWorkHours = attendanceRecords.reduce((sum, r) => sum + (r.work_hours || 0), 0);

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl sm:text-3xl font-bold text-white">Attendance</h1>
        <p className="text-slate-400 mt-1">Track your work hours and attendance</p>
      </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        ...
        <div className="bg-slate-800 rounded-xl p-4 border border-slate-700">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-white">{totalWorkHours.toFixed(1)}</p>
      ...
      <div className="bg-slate-800 rounded-xl border border-slate-700 overflow-hidden">
        <div className="p-4 border-b border-slate-700">
          <h2 className="text-lg font-semibold text-white">This Month&apos;s Attendance</h2>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-16 text-slate-400">
            ...
            <p className="text-sm">Clock in to start recording your attendance</p>
          </div>
        ) : (
            ...
            <table className="w-full">
              <thead className="bg-slate-700/50">
                <tr>
                  ...
                  <th className="px-6 py-3 text-left text-xs font-semibold text-slate-300 uppercase">Clock In</th>
                  <th className="px-6 py-3 text-left text-xs font-semibold text-slate-300 uppercase">Clock Out</th>
                  <th className="px-6 py-3 text-left text-xs font-semibold text-slate-300 uppercase">Work Hours</th>
                </tr>
              </thead>
